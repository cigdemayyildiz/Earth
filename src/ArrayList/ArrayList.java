...
public class ArrayList {
    ...
    public static void main(String[] args) {
        ...
        java.util.ArrayList list2 = new java.util.ArrayList(3);

        java.util.ArrayList list3 = new java.util.ArrayList(list1);

        java.util.ArrayList<Integer> list4 = new java.util.ArrayList<>();

        java.util.ArrayList<Double> list5 = new java.util.ArrayList<Double>();
        ...
        System.out.println(list2.get(3)); // white
