...
public class EndsWithMethod {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(school.endsWith("demy")); // true
        System.out.println(school.endsWith("Techtorial Academy")); // true
        System.out.println(school.endsWith("rial")); // false
        System.out.println(school.endsWith("")); // true
        System.out.println(school.endsWith(" ")); // false
