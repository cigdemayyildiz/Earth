...
public class LogicalOperators {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Can I go that event? --> " + attend2); // false

        boolean attend3 = myAge <= ageRequirement && myDress == casualDress;
        System.out.println("Can I go that event? --> " + attend3); // true
        ...
        System.out.println("Can I go that event? --> " + go); // true

        myNewAge = 8;
        go = myNewAge >= ageRqrmnt || myMoney==moneyRqrmnt;
        System.out.println("Can I go that event? --> " + go); // false
