...
public class Variables3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total apple price is " + (apple*applePrice) + " and total banana price is "
                + (banana*bananaPrice) + ".");

        int totalApplePrices = apple*applePrice;
        int totalBananaPrices = banana*bananaPrice;

        System.out.println("Total apple price is " + totalApplePrices + " and total banana price is "
                + totalBananaPrices + ".");
